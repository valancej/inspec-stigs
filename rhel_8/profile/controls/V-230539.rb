...
or either returned line is commented out, this is a finding.
  "
  desc  'fix', "
    Configure RHEL 8 to not forward source-routed packets by default with the
following commands:
