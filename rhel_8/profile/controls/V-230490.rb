...
control 'V-230490' do
  title 'RHEL 8 must not have the gssproxy package installed.'
...
disabled is to not have the capability installed.
  ...
  desc  'rationale', ''
  desc  'check', "
    Check to see if the gssproxy package is installed with the following
command:
...
removing the gssproxy package from the system with the following command:
  ...
  tag gid: 'V-230490'
  tag rid: 'SV-230490r599732_rule'
  tag stig_id: 'RHEL-08-040003'
  tag fix_id: 'F-33134r568217_fix'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
end
