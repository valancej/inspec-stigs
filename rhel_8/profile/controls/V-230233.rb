...
algorithms for all created passwords."
...
following commands:
    ...
    If \"rounds\" has a value below \"5000\", or is commented out in either
...
cryptographic hash.
    ...
    Edit/modify the following line in the \"/etc/pam.d/password-auth\" and
\"etc/pam.d/system-auth\" files and set \"rounds\" to a value no lower than
\"5000\":
